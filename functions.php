...
function sakura_scripts()
{
    if (akina_option('jsdelivr_cdn_test')) {
        ...
        wp_enqueue_script('js_lib', 'https://cdn.jsdelivr.net/gh/Antares0982/Sakura@' . SAKURA_VERSION . '/cdn/js/lib.min.js', array(), SAKURA_VERSION, true);
    }
    if (akina_option('app_no_jsdelivr_cdn')) {
        ...
        wp_enqueue_style('saukra_css', 'https://cdn.jsdelivr.net/gh/Antares0982/Sakura@' . SAKURA_VERSION . '/style.min.css', array(), SAKURA_VERSION);
        wp_enqueue_script('app', 'https://cdn.jsdelivr.net/gh/Antares0982/Sakura@' . SAKURA_VERSION . '/js/sakura-app.min.js', array(), SAKURA_VERSION, true);
    }
...
function custom_html()
{
    if (akina_option('login_bg')) {
        ...
        $loginbg = 'https://cdn.jsdelivr.net/gh/Antares0982/Sakura@1.0.3/images/hd.png';
    }
